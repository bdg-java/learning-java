...
public class HRApplicationWithReturnStaffAfterRemoving {
    public static void main(String[] args) {
        ...
        HRManagemenetToolWithReturnStaffAfterRemoving tool = new HRManagemenetToolWithReturnStaffAfterRemoving(3);
...
//        System.out.println("Accounter removed:" + Arrays.toString(tool.removeEmployee(accounter)));
        ...
        System.out.println("Employees with salary range removed:" + Arrays.toString(tool.removeWithSalaryRange(20, 999)));
        ...
        System.out.println("third employee added again:" + tool.addEmployee(hrspecialist));
