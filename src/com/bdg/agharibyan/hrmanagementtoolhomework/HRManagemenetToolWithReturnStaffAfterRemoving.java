...
public class HRManagemenetToolWithReturnStaffAfterRemoving {
    private Employee[] employees;
    private static final int DEFAULT_CONTAINER_SIZE = 10;

    private int currentEmployeeCount;

    public HRManagemenetToolWithReturnStaffAfterRemoving(int initialSize) {
        this.employees = new Employee[initialSize];
        this.currentEmployeeCount = 0;
    }

    public HRManagemenetToolWithReturnStaffAfterRemoving() {
...
//        }
    ...
    public Employee[] removeEmployee(Employee employee) {
        ...
        for (int i = 0; i < currentEmployeeCount; i++) {
            if (this.employees[i]!= null && this.employees[i].referenceNumber == employee.referenceNumber) {
